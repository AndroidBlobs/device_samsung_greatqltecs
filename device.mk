...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/android.hardware.vr.high_performance.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.vr.high_performance.xml \
...
# Inherit vendor
$(call inherit-product, vendor/samsung/greatqltecs/greatqltecs-vendor.mk)